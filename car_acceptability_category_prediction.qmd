...
The dataset shows significant class imbalance as shown in @tbl-frequency_dsitri-car, with the `unacc` (unacceptable) class dominating at 71% of the original data (1,210 out of 1,728 instances). This imbalance may skew model predictions, leading to poor performance on the minority classes (`good`, `vgood`).
