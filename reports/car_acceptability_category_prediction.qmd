...
![Distribution of Car Evaluations](){#fig-car_distribution_plot}
...
![Safety vs. Evaluation Class](){#fig-car_safety_plot}

![Buying vs. Evaluation Class](){#fig-car_buying_plot}

![Number of Passenger vs. Evaluation Class](){#fig-car_persons_plot}

![Maintenance vs. Evaluation Class](){#fig-car_maintenance_plot}

![Luggage Boot Size vs. Evaluation Class](){#fig-car_luggage_plot}

![Number of Doors vs. Evaluation Class](){#fig-car_doors_plot}
...
![Distribution of Car Evaluations After Feature Engineering](){#fig-car_distri_after_enginerring_plot}
...
![Safety vs. Evaluation Class with Class Balance](){#fig-car_safety_balance_plot}

![Buying vs. Evaluation Class with Class Balance](){#fig-car_buying_balance_plot}

![Number of Passenger vs. Evaluation Class with Class Balance](){#fig-car_persons_balance_plot}

![Maintenance vs. Evaluation Class with Class Balance](){#fig-car_maintenance_balance_plot}

![Luggage Boot Size vs. Evaluation Class with Class Balance](){#fig-car_luggage_balance_plot}

![Number of Doors vs. Evaluation Class with Class Balance](){#fig-car_doors_balance_plot}
...
![Correlation Heatmap](){#fig-corr_heatmap}

This visualization @fig-corr_heatmap illustrates the correlation and feature importance of various factors that influence car evaluation outcomes. The values range from -1, indicating a strong negative association, to +1, which indicates a strong positive association.
...
accuracy <- round(conf_matrix$overall[1],3)
kappa <- round(conf_matrix$overall[2],3)
accuracy_pecentage <- round(conf_matrix$overall[1]*100)
